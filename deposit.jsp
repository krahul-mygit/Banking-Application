...
<body>
	...
	<div class="container middle my-2">
		<h4 class="display-4 text-center"> Deposit </h4>
	</div>
        	...
        	<div class="col-md-5 col-md-offset-4">
        		<form action="processDeposit.jsp" method="post">
        			<div class="form-group">
        				...
        				<input type="text" class="form-control"  autocomplete="off"  name="customerAccountNumber" id="accountnumber" required autofocus>
        				<label for="amount">Amount:</label>
        				<input type="text" class="form-control" autocomplete="off"  name="balance" id="amount" required >
        				<br>
        				<input type="submit" value="Deposit" class="btn btn-primary" name="deposit " >
        			</div>
        		</form>
        	</div>	        
        </div>
