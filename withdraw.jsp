...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse justify-content-end" id="mainnav">
				<div class="navbar-nav navigation-links">					
					...
					<a href="withdraw.jsp" class="nav-item nav-link active"> Withdraw </a>
	...
	<div class="container ">
		<h4 class="display-4 text-center my-2"> Withdraw </h4>
	</div>
        	...
        	<div class="col-md-5 col-md-offset-4">
        		<form action="processWithdraw.jsp" method="post">
        			<div class="form-group">
        				...
        				<input type="text" class="form-control" name="customerAccountNumber" id="accountnumber" autocomplete="off" required autofocus>
        				<label for="amount">Amount:</label>
        				<input type="text" class="form-control" name="balance" id="amount" autocomplete="off"  required >
        				<br>
        				<input type="submit" value="Withdraw" class="btn btn-primary" name="withdraw " >
        			</div>
        		</form>
        	</div>	        
        </div>
