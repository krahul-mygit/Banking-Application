			...
			<div class="container">
				...
				<div class="collapse navbar-collapse justify-content-end" id="mainnav">
					<div class="navbar-nav navigation-links">
						...
						<a href="newaccount.jsp" class="nav-item nav-link active"> New Account </a>
...
<%-- <div class="container content my-3 content">
		<div class="row">
			<div class="col-md-6">
				...
				<p class="lead"> 
						...
						hello=<%String s=(String)request.getAttribute("errorMessage");
							out.print(s);
							out.print("hello");
						%>
				<%
...
%>			
		 ...
		 --%>
	<div class="container middle my-2">
		<h4 class="display-4 text-center"> Create Account </h4>
	</div>
	<div class="container justify-content-center py-4">
		<div class="row">
			<div class="col-md-6"> 
				<form action="processNewAccount.jsp" method="post">
					<div class="form-group">
						<label for="name">  Name:</label>
							<input type="text" name="name" id="name"  autocomplete="off"  placeholder="Enter Name" autofocus required class="form-control">
						
						<label for="email">  Email:</label>
							<input type="email" name="email" id="email"  autocomplete="off"  placeholder="Enter Email" required  class="form-control">				
						<label for="password">  Password:</label>
							<input type="password" name="password" id="password" autocomplete="off"  placeholder="Enter Password" required class="form-control">
						<label for="contact">  Contact:</label>
							<input type="tel" name="contact" id="contact" autocomplete="off"  placeholder="Enter Contact" required class="form-control">
						
						<label for="address">  Address:</label>
							<input type="text" name="address" id="address"  autocomplete="off"  placeholder="Enter Address" required class="form-control">
						<br>
