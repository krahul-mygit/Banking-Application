<%@page import="bank.User,bank.UserStructure,java.sql.*,java.util.List,java.util.ArrayList" %>
...
<%
	...
	try{	
		...
		System.out.println("Deposit page Exception is: "+ e);
	}
%>
...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse justify-content-end" id="mainnav">
					<div class="navbar-nav navigation-links">
						...
						<a href="deposit.jsp" class="nav-item nav-link active"> Deposit </a>
	...
	<div class="container middle my-2">
		<h4 class="display-4 text-center"> User Queries </h4>
	</div>
	<div class="container">
		<div class="table-responsive">
			<table class="table table-cordered table-bordered table-striped tabl-hover">
				<tr class="bg-primary">
				<th> Name </th>
				<th> Email </th>
				<th> Comments </th>
				...
				<%
				ArrayList<UserStructure> li=User.getQueries();
				for(int i=0;i<li.size();i++)
				{
			%>
				<tr>
				
				<td> <%out.println(li.get(i).getUserName()); %> </td>
				<td> <%out.println(li.get(i).getUserEmail()); %></td>
				<td> <%out.println(li.get(i).getUserComments()); %></td>
				</tr>
				<%} %>
			</table>
		</div>
