	...
	<div class="container content my-3">
		<div class="row">
			<div class="col-md-6">
				...
				<p class="lead"> You account is successfully opened. Your Account Number is:
				<% 
					
					out.print(session.getAttribute("account_number"));
					
				%>
				and your UserID is <% out.print(session.getAttribute("userId")); %>
				</p>
