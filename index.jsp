<%@page import="bank.User,bank.UserStructure" errorPage="error404.jsp" %>
...
<body>
	...
	<nav class="navbar navbar-toggleable-md navbar-expand-md  bg-primary navbar-inverse navbar-dark fixed top">
		...
		<div class="container-fluid content bgimage text-white">
		<div class="row ">
			<div class="col-md-6 text-center">
				<h3 class="display-3 py-5 heading"> Creating a  better <br> banking <br> experience for <br> you. </h3>
			</div>
			<div class="col-md-6">
				<h3 class="display-4 pt-3"> Login</h3>
